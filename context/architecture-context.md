...
- New editor projects use a room-safe project ID so the Project ID and Liveblocks room ID stay aligned.
...
- Execution: durable background task via Trigger.dev.
- Output: Markdown technical spec saved to Vercel Blob and linked to the project in the database with `ProjectSpec` metadata.
